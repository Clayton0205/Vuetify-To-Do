<template>
  <div class="home">
    <v-text-field v-model="newTaskTitle" @click:append="addTask" @keyup.enter="addTask" class="pt-5" outlined label="Add Task" append-icon="mdi-plus" hide-details clearable></v-text-field>
